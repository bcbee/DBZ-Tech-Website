...
<div id="consulting" style="background: url(/Resources/Images/View-3.svg); width: 100%; height: 100%;">
    <div class="sidenav">
        <h1>Consulting</h1>
        ...
        <br />
        <a class="button longbutton" href="#">Portfolio</a>
        <a class="button longbutton" href="#">Creation</a>
        <a class="button longbutton" href="#">Solutions</a>
    </div>
</div>
