...
<div id="consulting" style="background: url(/Resources/Images/View-3.svg); width: 100%; height: 100%; background-position-y: -200px;">
    <div class="sidenav">
        <h1>Consulting</h1>
        ...
        <a class="button longbutton" href="/Portfolio?view=Creation&back=Consulting"> Computer Creation</a>
        <a class="button longbutton" href="/Portfolio?view=Repair&back=Consulting"> Computer Repair</a>
    </div>
</div>
