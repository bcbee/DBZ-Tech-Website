...
<div id="consulting">
    <div class="leftcontentlogo img-circle" style="background: url(/Resources/Images/View-3.svg);background-size: 1500px;background-position-x: -135px;background-position-y: -155px;"></div>
    ...
    <div class="rightcontent">
        ...
        <br />
        <a class="btn btn-success longbutton" href="/Solutions?back=Technology">Portfolio</a>
        <a class="btn btn-success longbutton" href="/Portfolio?view=Creation&back=Technology"> Computer Creation</a>
        <a class="btn btn-success longbutton" href="/Repair?back=Technology"> Computer Repair</a>
    </div>
</div>
